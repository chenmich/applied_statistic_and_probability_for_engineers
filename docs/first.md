...
!!!note "图1.5、蒸馏实例的丙酮浓度计点图，不能辨识丙酮浓度的时间稳定性"
...
!!!note "图1.8、将调整应用到扰动过度控制系统并增加了最终的偏差"
...
!!!note "图1.9、在57号试验时检测到系统的偏差平均值并做出(减少2个单位)的调整，这会减少最终的系统偏差"
...
!!!note "图1.11、枚举研究和分析研究"
    ![fig1.11](images/fig1.11.png)
